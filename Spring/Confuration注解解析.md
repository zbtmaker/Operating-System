...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
                ...
                // 这里通过调用ConfigurationClassPostProcessor的postProcessBeanFactory方法实现@Configuration注解解析
	...
	/**
     * 这里的BeanPostProcessor交给PostProcessorRegistrationDelegate处理
...
public class ConfigurationClassPostProcessor implements BeanDefinitionRegistryPostProcessor,
	...
	public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) {
        ...
        // 这个方法里面初始化ConfigurationClassParser类并在ConfigurationClassParser类中解析@Configuration
...
class ConfigurationClassParser {
	protected void processConfigurationClass(ConfigurationClass configClass, Predicate<String> filter) throws IOException {
        ...
        // 这里首先从map中获取已经加载过的ConfigClass，如果加载过了则跳过加载，防止重复加载造成死循环
        ...
        // 这里有一个循环主要是被注解了@Configuration的类还有父类时需要将父类也要进行解析，直到没有父类时，此时sourceClass = null，循环结束
	...
	protected final SourceClass doProcessConfigurationClass(
			...
			throws IOException {
        // 这里有点没明白是要做什么，如果这个类上面有@Component注解，那么需要处理其内部类
		if (configClass.getMetadata().isAnnotated(Component.class.getName())) {
			// Recursively process any member (nested) classes first
			processMemberClasses(configClass, sourceClass, filter);
		}

        // 如果注解了@Configuration注解上面有@PropertySource注解，那么就需要解析@PropertyResource注解里面的配置
        ...
        // 这里处理的是@Configuration注解上面的@ComponentScans和@ComponentScan注解，这两个注解一起解析之后得到需要扫描的包名或者类
        ...
        // 这里处理@Configuration注解上main的@ImportResource注解
        ...
        // 这里处理@Configuration注解类里面注解在方法上面的@Bean注解
